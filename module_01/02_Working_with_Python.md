...
```{code-cell} ipython3
arr_3 = np.random.randint(0, 100, size=10000)
arr_4 = np.random.randint(0, 100, size=10000)
print(arr_1[0:10])
print(arr_2[0:10])
print()
```
...
xarray
#Plot x^3-x^2
plt.plot(xarray, res1, color='red', linestyle='-', label='$x^3-x^2$')
#Plot x^2*x^3
plt.plot(xarray, res2, color='green', linestyle='-', label='$x^2*x^3$')
#Plot the legends in the best location
plt.legend(loc='best');
```
...
#The above commands removes the Euler's number, e, by changing the precision

def sincos(x):
    '''
    sincos(x): calculates the sinx and cosx of the array inputted, x.
    ...
    Returns
    -------
    returns a tuple showing the two arrays, sin(x) then cos(x)'''
...
piarray = np.arange(0, two_pi, pi_over_4) #an input array example
#np.arange(start, stop, step) gives an array of evenly spaced values in a defined interval.
#From zero to 2pi, there are 8 steps.

sines, cosines = sincos(piarray) #assigns the sin(x) as 'sines' and the cos(x) as 'cosines' from  the sincos(x) function

#Plot sines of piarray
plt.plot(piarray, sines, color='red', linestyle='-', label='sin(x)')
#Plot cosines of piarray
plt.plot(piarray, cosines, color='green', linestyle='-', label='cos(x)')
#Plot the legends in the best location
plt.legend(loc='best');
```
...
A_99o = [[i*j for i in range(10)] for j in range(10)]
A_99 = np.reshape(A_99o, (10,10))
#print(A_99)
total = A_99.sum()
print()
#print(total)
print('mean of A_99 is', total/100)
print()
print()
print('Standard Deviation of A_99 is',np.std(A_99))
print()
print()
```
...
print()
#print(total)
print('mean of A_99 is', total/100) #total/(number of values) number of values = 10*10
print()
print()
print('Standard Deviation of A_99 is',np.std(A_99))
print()
print()
plt.contourf(X,Y,X*Y) #plt.contourf() shades in, plt.contour() doesn't shade in
```
